...
|---------|---------------|-------------|-------|
| `maps.tracecast.yaml` | Drives a real site (OpenStreetMap): tours world landmarks (Paris → Rome → Sydney), asserts + screenshots each stop | browser, network | The README hero demo; needs internet |
